...
public class RatingFragment extends Fragment implements View.OnClickListener, IRatingFragmentView,
    ...
    private GalleryVideoList ratingVideoDetail;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        OnBackPressedCallback backPressedCallback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                Log.d("JEBYRNE", "RatingFragment.onBackPressed");
    ...
    public void onCollectionSelection(GalleryVideoList collectionsData, int position) {
        ...
        this.ratingVideoDetail = collectionsData;
        IRPresenter.getCollectionDetails(ratingVideoDetail.getCollection_id());
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.termsOfUse:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://visym.com/legal.html"));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (id) {
            ...
            case R.id.faq:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://visym.com/faq.html"));
                startActivity(browserIntent);
                break;

            case R.id.about:
                Intent aboutIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://visym.com/collector"));
    ...
    @Override
    public void onCollectionDetailDownload(CollectionModel collection) {
        if (Globals.isShowingLoader()) {
            Globals.dismissLoading();
        }

        if (collection == null){
            Toast.makeText(getActivity(), getString(R.string.download_failed_message),
        ...
        if (getContext() != null) {
            ...
            intent.putExtra("module", "ratings");  // JEBYRNE: so that VideoPlayerActivity knows that this should be played with ratings
            intent.putExtra("jsonURL", ratingVideoDetail.getAnnotation_file_path());
            intent.putExtra("videoURL", ratingVideoDetail.getRaw_video_file_path());
            intent.putExtra("videoId", ratingVideoDetail.getVideo_id());
            intent.putExtra("instanceData", ratingVideoDetail.getInstance_ids());
            intent.putExtra("collectionDetail", new Gson().toJson(collection, CollectionModel.class));
