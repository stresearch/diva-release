...
public class ConsentConfirmationActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    @BindView(R.id.closeBtn_consent_confirmation)
    ...
    JSONArray userQuestionnaireResponseArray, sortedUQResponse,projectQuestionResponse;
        ...
        if (preference.readString(Constant.SUBJECT_EMAIL_TEXT) != null) {
            ...
            try {
                ...
                if (recentSubjects.length() == 0) {
                    ...
                    Log.e(Globals.TAG, "initConsentSubjectObjects: recent Subject length " + recentSubjects.length());
    ...
    public void onClick(View v) {
        Log.d("JEBYRNE", "ConsentConfirmationActivity.onClick: FIRED");

        switch (v.getId()) {
            case R.id.closeBtn_consent_confirmation:
                displayCloseButtonDialog("Exit this collection?");
                break;
            ...
            case R.id.disagreeBtn:
                if (disagreeDestinationIdAdapterPosition >= 0 && consentQuestionsList != null && !consentQuestionsList.isEmpty()) {
            ...
            case R.id.confirmBtn:
                if (!isconsentConfirmClicked ) {
                    ...
                    if (TextUtils.isEmpty(consentEmail)) {
                        Toast.makeText(this, "Please enter or select your subject's email address",
                    ...
                    Globals.getAppSyncClient().query(SubjectByStrSubjectEmailQuery.builder()
                            .subject_email(programName+"_"+consentEmail).build())  // JEBYRNE
            ...
            case R.id.userConsentResponseBtn:
                ...
                if (!isDisagreeConsentResponse) {
                   ...
                   /* if(projectQuestionResponse != null){
                        preference.storeValue(Constant.PROJECT_QUESTION_RESPONSE,projectQuestionResponse.toString());
                    }*/
                    if (!consentVersion.isEmpty()) {
                        preference.storeValue(Constant.CONSENT_VERSION, consentVersion);
                    }
                    captureVideoIntent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                    ...
                    redirectCollectionActivity.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
    ...
    private GraphQLCall.Callback<SubjectByStrSubjectEmailQuery.Data> subjectDev = new GraphQLCall.Callback<SubjectByStrSubjectEmailQuery.Data>() {
        ...
        public void onResponse(@Nonnull Response<SubjectByStrSubjectEmailQuery.Data> response) {
            runOnUiThread(() -> {
                ...
                //learnMoreText.setVisibility(View.GONE);  // JEBYRNE
                if (Globals.isShowingLoader()) {
                    Globals.dismissLoading();
                }
                if (response.data() != null) {
                    if (response.data().subjectByStrSubjectEmail() != null &&
                        ...
                        if (consentEmail.startsWith(programName)) {
                            consentEmail = consentEmail.replaceFirst(programName+"_", "");  // JEBYRNE: consent email is always PROGRAM_emailaddress, for program specific consent
                        }
                                   ...
                                   /* Intent videoCaptureIntent = new Intent(ConsentConfirmationActivity.this,
                                    ...
                                    if (isPlayTrainingVideo) {
                                        ...
                                        if (TextUtils.isEmpty(trainingVideoURL) || trainingVideoURL.contentEquals("[]")) {
                                            Intent setupScreenIntent = new Intent(ConsentConfirmationActivity.this,
                                                    VideoCaptureActivity.class);
                                            setupScreenIntent.putExtra("module","notraining");
    ...
    public void onBackPressed() {
        Log.d("JEBYRNE", "ConsentConfirmationActivity.onBackPressed");
        if (isConsentSAgreeDisagreeGroup) {
            consentConfirmationGroup.setVisibility(View.VISIBLE);
            consentAgreeDisagreeGroup.setVisibility(View.GONE);
            userResponseGroup.setVisibility(View.GONE);
        ...
        } else if (!Globals.isShowingLoader()){
            super.onBackPressed();
        }
                ...
                .setPositiveButton("Yes",
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                learnMoreText.setVisibility(View.GONE);  // JEBYRNE: remove learnMOreText when consenting new subject
                                continueFlowFunction();
