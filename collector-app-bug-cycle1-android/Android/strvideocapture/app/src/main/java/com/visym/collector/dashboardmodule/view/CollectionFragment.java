...
public class CollectionFragment extends Fragment implements ICollectionFragmentView,
    ...
    private UserVideoList selectedVideo;
    private boolean isVideoEditable;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        OnBackPressedCallback backPressedCallback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                Log.d("JEBYRNE", "CollectionFragment.onBackPressed");
    ...
    public void onCollectionSelection(UserVideoList collectionsData, int position) {
        Log.d("JEBYRNE", "CollectionFragment.onCollectionSelection");
        if (getActivity() == null) {
            return;
        }
        Globals.showLoading(getActivity());
        isVideoEditable = false;
        this.selectedVideo = collectionsData;
        ICPresenter.getCollectionDetails(collectionsData.getCollectionId());
    }
    ...
    public void onCollectionDetailDownload(CollectionModel collection) {
        ...
        intent.putExtra("jsonURL", selectedVideo.getRaw_json_file_path());
        intent.putExtra("videoURL", selectedVideo.getRaw_video_file_path());
        intent.putExtra("collectionDetail", new Gson().toJson(collection, CollectionModel.class));
        intent.putExtra(Constant.IS_VIDEO_EDITABLE, isVideoEditable);
