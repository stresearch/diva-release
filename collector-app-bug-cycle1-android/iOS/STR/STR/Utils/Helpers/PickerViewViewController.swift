...
extension UIAlertController {
    ...
    func addPickerView(
        ...
        initialSelection: PickerViewViewController.Index? = nil,
        action: PickerViewViewController.Action?
    ) {
        let pickerView = PickerViewViewController(
            values: values,
...
final class PickerViewViewController: UIViewController {
    ...
    public typealias Action = (
        _ vc: UIViewController, _ picker: UIPickerView, _ index: Index, _ values: Values
    ) -> Void
    ...
    fileprivate lazy var pickerView: UIPickerView = { return $0 }(UIPickerView())
    ...
    override func viewWillAppear(_ animated: Bool) {
            ...
            values[initialSelection.column].count > initialSelection.row
        {
            pickerView.selectRow(
                ...
                inComponent: initialSelection.column,
                animated: true
            )
        }
    }
...
extension PickerViewViewController: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    public func numberOfComponents(in pickerView: UIPickerView) -> Int { return values.count }
    ...
    ) -> String? { return values[component][row] }
