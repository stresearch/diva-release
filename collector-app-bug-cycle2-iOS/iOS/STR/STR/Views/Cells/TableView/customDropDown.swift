...
//            self.tableheightX = listHeight
        ...
        if (self.tableheightX > rowHeight*5) {
            self.tableheightX = rowHeight*5;  // JEBYRNE: requires isScrollEnabled = true, and flashScrollIndicators()
        }
        ...
        table.isScrollEnabled = true  // JEBYRNE
        ...
        self.table.flashScrollIndicators()  // JEBYRNE            
    }
...
extension customDropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //cell?.textLabel?.adjustsFontSizeToFitWidth = true;  // JEBYRNE: this will downscale font to fit
        cell?.textLabel?.numberOfLines = 0;  // JEBYRNE: this will wordwrap
