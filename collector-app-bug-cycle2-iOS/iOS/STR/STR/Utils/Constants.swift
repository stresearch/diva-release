...
let kNoActivities =  "You didn't select any activity"//"Your collection has no activities. Submit?"
...
let kCollectionVideoMaxDuration = 45
...
//MARK: DropBox
let kDropBoxAppKey = ""  // JEBYRNE: sanitized
