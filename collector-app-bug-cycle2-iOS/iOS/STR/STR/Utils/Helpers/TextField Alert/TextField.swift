...
open class TextField: UITextField {
    ...
    public func configure(configurate: Config?) { configurate?(self) }
    ...
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        return bounds.insetBy(
            dx: (leftTextPadding ?? 8) + (leftView?.width ?? 0) + (leftViewPadding ?? 0),
            dy: 0
        )
    }
    ...
    @objc func textFieldDidChange(_ textField: UITextField) { actionEditingChanged?(self) }
}
