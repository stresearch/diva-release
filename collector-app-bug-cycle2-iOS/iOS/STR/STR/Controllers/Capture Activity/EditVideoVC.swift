...
class EditVideoVC: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if editVideoFlow != .MyVideoPreview {
            //coloredProgress()  // JEBYRNE: https://github.com/visym/collector-app/issues/31
        }
...
//            }
    ...
    @IBAction func editBtnPressed(_ sender: UIButton) {
        ...
        if editVideoFlow == .MyVideoPreview {
            //self.coloredProgress()  // JEBYRNE: https://github.com/visym/collector-app/issues/31
        }
...
extension EditVideoVC: PlayerPlaybackDelegate {
    ...
    func playerPlaybackDidEnd(_ player: PlayerController) {
        ...
        if isObjectTracking {
            // Alternative Solution Starts
            //getDefaultObjectMissingFrames()  // JEBYRNE: too slow
...
//            trimActivities()
            ...
            // JEBYRNE: this is too slow, disable me, removed in 2.2 (54)
            // https://github.com/visym/collector-app/issues/31
            //coloredProgress()
...
//            }
    ...
    private func saveObjectChanges() {
        ...
        getDefaultObjectMissingFrames();  // JEBYRNE
        if editSubjectCordinates.count > 0 {
